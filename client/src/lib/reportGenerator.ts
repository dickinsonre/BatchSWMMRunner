...
<title>BatchSWMM56 Comparison Report</title>
<style>
...
<body>
<h1>BatchSWMM56 Comparison Report</h1>
...
<p class="meta" style="text-align:center;">Report generated by BatchSWMM56</p>
</body>
</html>`;
}
...
export function generateMarkdownReport(results: ProcessResult[]): string {
  ...
  const lines: string[] = [];
  lines.push("# BatchSWMM56 Comparison Report");
  lines.push("");
  ...
  lines.push("---");
  lines.push("*Report generated by BatchSWMM56*");
