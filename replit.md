...
- **Jul 2026 (latest)**: Added SWMM6 (Browser) engine mode — OpenSWMM SWMM6 fork (github.com/SWMMBobSWMM6/openswmm.engine, release branch; EPA SWMM 5.2.4 + extra WARN13 link-depth validation) compiled to WASM at `client/public/wasm6/`, source in `swmm6-source/`; shared worker loads either engine on demand
